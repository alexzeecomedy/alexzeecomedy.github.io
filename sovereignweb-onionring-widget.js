    ...
    <tr>
      <td class="webring-prev" style="padding: 0; vertical-align: middle; text-align: center;">
        <a href="${sites[previousIndex]}">
          <img width=13 height=31 src="https://cdn.jsdelivr.net/gh/alexzeecomedy/alexzeecomedy.github.io@main/assets/artwork/leftarrow.gif" style="display: block; max-width: 100%; height: auto;" alt="Previous">
        </a>
      </td>
      <td class="webring-info" style="padding: 0; vertical-align: middle; text-align: center;">
        <a href="https://sovereignweb.thecozy.cat/join/">
          <img width=88 height=31 src="https://cdn.jsdelivr.net/gh/alexzeecomedy/alexzeecomedy.github.io@main/assets/artwork/TheSovereignWeb.gif" style="display: block; max-width: 100%; height: auto;" alt="Center Logo">
        </a>
      </td>
      <td class="webring-next" style="padding: 0; vertical-align: middle; text-align: center;">
        <a href="${sites[nextIndex]}">
          <img width=13 height=31 src="https://cdn.jsdelivr.net/gh/alexzeecomedy/alexzeecomedy.github.io@main/assets/artwork/rightarrow.gif" style="display: block; max-width: 100%; height: auto;" alt="Next">
        </a>
      </td>
    </tr>
  </table>
